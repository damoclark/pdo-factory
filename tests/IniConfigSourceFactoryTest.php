...
final class IniConfigSourceFactoryTest extends TestCase
{
  ...
  {
    $c = ConfigSourceFactory::create('tests/etc/valid.ini');
  ...
  public function testWillThrowOnInvalidPDOParameters()
  {
    ...
    ConfigSourceFactory::create('tests/etc/invalid.ini');
  }
